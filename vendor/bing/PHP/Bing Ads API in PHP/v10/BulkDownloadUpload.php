...
$UserName = "<ajosephjohnson@microsoft.com>";
$Password = "<redrum999>";
$DeveloperToken = "<041F63U87G121059>";
$CustomerId = "<42143711>";
$AccountId = "<71045551>";
...
$BulkFilePath = "/Applications/XAMPP/htdocs/api3/Bulk";

// // The full path to the previously extracted bulk file.
// // This file is used to access the last sync time.

// $ExtractedFilePath = "/Applications/XAMPP/htdocs/api3/Bulk/accounts.csv";

// // The full path to the upload result file.

// $UploadResultFilePath = "\\Applications\\XAMPP\\xamppfiles\\htdocs\\api3\\bulk\\uploadresults.zip";
...
if (!is_dir($BulkFilePath))
{
    printf("The output folder, %s, does not exist.\nEnsure that the " .
        "folder exists and try again.", $BulkFilePath);
    return;
}
